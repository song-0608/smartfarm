// SVG Icon Components for 智农规划
// Each icon is a functional component that accepts size and className props
...
// Trending down icon
export function TrendDownIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// Leaf/plant icon (for agriculture theme)
...
export function TractorIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M7 18h3" />
      <path d="M18 18h2" />
      <path d="M10 15V5l-4-2v7" />
      <path d="M10 5h10a2 2 0 0 1 2 2v3" />
      <path d="M6 15h12" />
    </svg>
  );
}
...
export function LightbulbIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M9 18h6" />
      <path d="M10 22h4" />
      <path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 6c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 0 1 8.91 14" />
    </svg>
  );
}
...
// Shield/check icon for verified
